...
from keyseq.presentation.hook_button_texts import (
    CAPTURE_IDLE_TEXT, HOOK_START_TEXT, TRIGGER_DISABLE_TEXT,
)
...
class FullHookFrame(ttk.LabelFrame):
    def __init__(self, parent, app: App):
        ...
        self.hook_toggle_btn = ttk.Button(self.full_hook_line1, text=HOOK_START_TEXT, command=app.hook.toggle_hook)
        self.trigger_toggle_btn = ttk.Button(self.full_hook_line1, text=TRIGGER_DISABLE_TEXT, command=app.hook.toggle_triggers_enabled, state="disabled")
        ...
        self.stop_key_capture_btn = ttk.Button(self.full_hook_line2, text=CAPTURE_IDLE_TEXT, command=app.toggle_stop_key_capture)
