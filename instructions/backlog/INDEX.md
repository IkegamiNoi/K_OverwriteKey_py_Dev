...
| idea_22 | [idea_22_full_view_min_height.md](idea_22_full_view_min_height.md) | フル表示のウィンドウに縦方向の最小サイズを設ける（目安 = 各一覧の既定の高さの半分）。 | **着手**（→ [phase 20](../phase/20_full_view_min_height/phase.md) / 暫定仕様 [18](../history/18_full_view_min_height.md)）|
