...
| idea_21 | [idea_21_full_view_header_width.md](idea_21_full_view_header_width.md) | フル表示のヘッダ（フック / 表示 / ファイル操作）の幅をウィンドウ最小幅で考慮する（ファイル操作の枠の中身が切れる）。文言が変わるボタンは最大サイズで固定し、キーボード選択のドロップダウンを 2/3 の幅にする。 | **着手**（→ 暫定仕様 [17](../history/17_full_view_header_width.md)〔v0.3・ユーザー確定済〕/ phase [19_full_view_header_width](../phase/19_full_view_header_width/phase.md)・2026-09-17 起票）|
